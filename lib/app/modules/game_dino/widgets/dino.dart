...
List<Sprite> dino = [
  Sprite()
    ..imagePath = "assets/games/dino/dino/dino_1.png"
    ..imageWidth = 88
    ..imageHeight = 94,
  Sprite()
    ..imagePath = "assets/games/dino/dino/dino_2.png"
    ..imageWidth = 88
    ..imageHeight = 94,
  Sprite()
    ..imagePath = "assets/games/dino/dino/dino_3.png"
    ..imageWidth = 88
    ..imageHeight = 94,
  Sprite()
    ..imagePath = "assets/games/dino/dino/dino_4.png"
    ..imageWidth = 88
    ..imageHeight = 94,
  Sprite()
    ..imagePath = "assets/games/dino/dino/dino_5.png"
    ..imageWidth = 88
    ..imageHeight = 94,
  Sprite()
    ..imagePath = "assets/games/dino/dino/dino_6.png"
    ..imageWidth = 88
    ..imageHeight = 94,
];
...
class Dino extends GameObject {
  ...
  Function(DinoState state)? onStateChange;
